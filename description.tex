...
This research delineates planetary conditions conducive to the origin
of life by determining the maximum radius permitted for rocky
exoplanets. As gaseous bodies are not expected to be habitable, this
identification of this boundary is critical for a successful search
...
to mass measurements, but our preliminary studies presented here
demonstrate that a careful analysis of \kepler data can provide strong
constraints on the composition of \kepler planets. Furthermore, constraining the importance of planetary system architecture, atmospheric mass loss, and tidal dissipation are also important aspects of the planetary habitability puzzle.
